...
We plotted each site by it's physical and ecological scores on XY axes (@fig-quadrant). Each point represents an individual site, and upon clicking directs to the location by opening up Google Maps in a new web browser page.
