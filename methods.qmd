...
# Create the plot
ggplot(merged_data_set, aes(x = Priority_Ecological, y = Priority_Physical)) +
  geom_point(color = "blue", size = 3) +
  labs(x = "Ecological Condition", y = "Physical Condition") +
  theme_minimal() +
  # Add the priority zones (adjust colors and labels as needed)
  geom_rect(xmin = 0, xmax = 10, ymin = 0, ymax = 5, fill = "pink", alpha = 0.8) +
  geom_rect(xmin = 10, xmax = 20, ymin = 0, ymax = 5, fill = "#199e19", alpha = 0.2) +
  geom_rect(xmin = 0, xmax = 10, ymin = 5, ymax = 10, fill = "lightblue", alpha = 0.8) +
  geom_rect(xmin = 10, xmax = 20, ymin = 5, ymax = 10, fill = "yellow", alpha = 0.8) +
  # Add priority labels
  ...
  annotate("text", x = 5, y = 7.5, label = "3 = Lo-Middle Priority", color = "black") +
  annotate("text", x = 15, y = 7.5, label = "1 = Highest Priority", color = "black") +
  # Add axes labels
  geom_segment(aes(x = 0, y = 0, xend = 10, yend = 0), arrow = arrow(length = unit(0.2, "cm"))) +
  geom_segment(aes(x = 0, y = 0, xend = 0, yend = 10), arrow = arrow(length = unit(0.2, "cm")))
