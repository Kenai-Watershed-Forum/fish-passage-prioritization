...
Methods described within this document are primarily for purposes of executing code to synthesize multiple fish passage  datasets. A more detailed report with an expanded methods section is available for download below.
