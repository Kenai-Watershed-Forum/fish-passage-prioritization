...
-   Our method employs a coded script-based approach to integrating various datasets, greatly simplifying the ease of annually updating results presented here. It is the first known published instance in the Kenai Peninsula Borough region to integrate and apply fish passage data inventories from multiple agencies.
